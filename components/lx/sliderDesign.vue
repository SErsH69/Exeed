	...
	<div class="lxDesign">
		<div class="container">
			<div class="lxPageSlider__content">
				<div class="lxPageSlider__title">Яркий дизайн</div>
				<div class="lxPageSlider__text">
					Выделяться из толпы совсем непросто, но результат того стоит. Вы и
					сами это прекрасно знаете. Как и команда художников, создававшая LX. В
					экстерьере нового внедорожника фамильные черты EXEED органично
					сочетаются со свежими дизайнерскими решениями. Броский дизайн и
					инновационный язык форм формирует дерзкий и уверенный образ нового LX.
					Для тех, кто рожден чтобы делать больше.
				</div>
		...
		>
			<template v-slot:content>
				<div v-swiper:lxDesignSwiper="swiperOption" class="lxDetails__slider">
					<div class="swiper-wrapper">
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/design-1.jpg')"
								alt="Спортивный стиль"
							...
							<div class="lxDetails__item-content">
								...
								<div class="lxDetails__item-text">
									Спортивный стиль LX подчеркивает эффектный динамичный силуэт и
									яркие элементы внешней отделки.
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/design-2.jpg')"
							...
							<div class="lxDetails__item-content">
								...
								<div class="lxDetails__item-text">
									Все исполнения премиального внедорожника оснащены полностью
									светодиодной головной оптикой. С электрической регулировкой
									светового потока по высоте. По LED-технологии выполнены и
									интегрированные в блок-фару дневные ходовые огни.
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/design-3.jpg')"
								alt="Большая панорамная крыша"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
									Большая панорамная крыша
								</div>
								<div class="lxDetails__item-text">
									Панорамная крыша подчеркивает ощущение пространства и света.
									Площадь остекления составляет около 1 м2. Шторка крыши
									защищает от нагрева, затемняет салон.
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/design-4.jpg')"
								alt="Интересные детали и шины 19”"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
									Интересные детали и шины 19”
								</div>
								<div class="lxDetails__item-text">
									19” литые двухцветные диски, расширители колесных арок,
									эффектная решетка радиатора создают спортивный образ.
								</div>
							</div>
						</div>
					</div>
...
export default {
	...
	methods: {
		showModal() {
			...
			setTimeout(() => {
				this.lxDesignSwiper.update();
			}, 100);
			this.slidesLength = this.lxDesignSwiper.slides.length;
...
.lxDesign
	...
	background-image: url('@/assets/img/lx/design.jpg')
	position: relative
	&:after
		content: ''
		position: absolute
