	...
	<div class="lxStyle">
		<div class="container">
			<div class="lxPageSlider__content">
				<div class="lxPageSlider__title">Стиль и комфорт</div>
				<div class="lxPageSlider__text">
					Современный темп жизни диктует свои правила: <br />
					в попытках все успеть, мы окружаем себя лишь самым необходимым. <br />
					Отказываемся от лишнего. Проникаемся философией разумного потребления.
					<br />
					И новый Exeed LX – как раз про это. <br />
					Обладая компактными габаритами, этот премиальный внедорожник вобрал в
					себя все самые современные технологии и опции. <br />
					Куда бы вы ни отправились, он сделает вашу жизнь еще приятнее. Еще
					ярче. И еще проще.
				</div>
		...
		>
			<template v-slot:content>
				<div v-swiper:lxStyleSwiper="swiperOption" class="lxDetails__slider">
					<div class="swiper-wrapper">
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/style-1.jpg')"
								alt="Эргономика и пространство салона"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
									Эргономика и пространство салона
								</div>
								<div class="lxDetails__item-text">
									Интерьер нового Exeed LX – та зона комфорта, из которой точно
									не захочется выходить. Анатомические передние кресла с
									сервоприводами и функцией памяти на нескольких водителей
									позволят мгновенно подобрать оптимальную посадку. Регулируемый
									по высоте и вылету руль буквально ляжет в руки. Усиленная
									шумоизоляция отсека двигателя, акустическое лобовое стекло и
									стекла передних дверей создают уютное тихое пространство, а
									также поглощают до 99% ультрафиолетовых лучей.
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/style-2.jpg')"
								alt="Функциональный багажник "
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
									Функциональный багажник
								</div>
								<div class="lxDetails__item-text">
									Возможности трансформации салона и огромный багажник позволяют
									организовать пространство так, как вам нужно для конкретных
									целей. Бесключевой и бесконтактный доступ в багажник добавит
									комфорта при поездке в гипермаркет — не нужно освобождать
									руки, занятые вещами, чтобы открыть багажник.
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/style-3.jpg')"
								alt="хранение вещей"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								...
								<div class="lxDetails__item-text">
									Вы наверняка оцените объем дверных карманов, в которые может
									поместиться книга, планшет или бутылка с водой.
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/style-4.jpg')"
								alt="Полный зимний пакет"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
								...
								<div class="lxDetails__item-text">
									LX поможет максимально комфортно перенести любую погоду.
									Отдельные дефлекторы для 2-го ряда создают комфортную
									температуру в салоне для задних пассажиров.
								</div>
							</div>
						</div>
					</div>
...
export default {
	...
	methods: {
		showModal() {
			...
			setTimeout(() => {
				this.lxStyleSwiper.update();
			}, 100);
			this.slidesLength = this.lxStyleSwiper.slides.length;
...
.lxStyle
	...
	background-image: url('@/assets/img/lx/style.jpg')
	position: relative
	&:after
		content: ''
		position: absolute
