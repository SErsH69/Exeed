	...
	<div class="lxSafety">
		<div class="container">
			<div class="lxPageSlider__content">
				<div class="lxPageSlider__title">Системы безопасности</div>
				<div class="lxPageSlider__text">
					Комплекс систем активной и пассивной безопасности поможет на дороге. И
					сделают каждую Вашу поездку спокойной.
				</div>
		...
		<lx-details
			...
			id="lxDetailsSafety"
			@close="closeModal"
			title="Системы активной и пассивной безопасности"
		>
			<template v-slot:content>
				<div v-swiper:lxSafetySwiper="swiperOption" class="lxDetails__slider">
					<div class="swiper-wrapper">
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/safety-1.jpg')"
								alt="Усиленный каркас и оцинковка"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
									Усиленный каркас и оцинковка
								</div>
								<div class="lxDetails__item-text">
									Для безопасности людей в салоне, высокопрочный кузов имеет
									усиленный каркас. При производстве автомобиля, был использован
									оцинкованный двусторонний стальной лист ~54% материала.
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/safety-2.jpg')"
								alt="ESP Bosch 9.3 + TMPS"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
								...
								<div class="lxDetails__item-text">
									LX имеет новейшую систему ESP Bosch 9.3:
									<ul>
										<li>Высокопроизводительный четырехъядерный процессор</li>
										<li>Новый цифровой датчик давления</li>
										<li>Более высокая скорость активного сброса давления</li>
										<li>Снижение уровня шума</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/safety-3.jpg')"
								alt="системы активной безопасности ADAS"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
								...
								<div class="lxDetails__item-text">
									<ul>
										...
										<li>Система смены полосы движения LCA</li>
										<li>
											Предупреждение о заднем перекрестном столкновении RCTW
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/safety-4.jpg')"
								alt="система кругового обзора 360°"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
								...
								<div class="lxDetails__item-text">
									При совершении маневров в ограниченном пространстве несколько
									камер обеспечивают масштабируемый вид на автомобиль сверху,
									позволяя Вам управлять автомобилем и парковаться уверенно и
									спокойно.
								</div>
							</div>
						</div>
						<div class="swiper-slide lxDetails__item">
							<img
								:src="require('@/assets/img/lx/safety-5.jpg')"
								alt="система помощи при спуске"
								class="lxDetails__image"
							/>
							<div class="lxDetails__item-content">
								<div class="lxDetails__item-title">
								...
								<div class="lxDetails__item-text">
									Дополнительную уверенность на бездорожье придадут системы
									помощи при подъеме и спуске. Первая поможет тронуться с места,
									не откатившись назад. Вторая возьмет на себя управление
									тормозами при движении под гору.
								</div>
							</div>
						</div>
					</div>
...
export default {
	...
	methods: {
		showModal() {
			...
			setTimeout(() => {
				this.lxSafetySwiper.update();
			}, 100);
			this.slidesLength = this.lxSafetySwiper.slides.length;
...
.lxSafety
	...
	background-image: url('@/assets/img/lx/safety.jpg')
	position: relative
	&:after
		content: ''
		position: absolute
